...
public partial class Net1710_221_7_GoodsExchangeContext : DbContext
{
    ...
    {
        optionsBuilder.UseSqlServer("data source=(local);initial catalog=Net1710_221_7_GoodExchange;user id=sa;password=12345;Integrated Security=True;TrustServerCertificate=True");
